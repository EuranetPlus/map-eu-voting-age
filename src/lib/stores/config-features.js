export const config = {
	mapTitle: 'eu-voting-age', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-eu-voting-age.vercel.app/', // The url provided when deploying the map on Vercel
